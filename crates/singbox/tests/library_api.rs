...
use singbox::{
    ...
    protocol::cloudflared_access::{
        CLOUDFLARED_ACCESS_JWKS_PATH, CLOUDFLARED_ACCESS_JWT_ASSERTION_HEADER,
    ...
    protocol::cloudflared_datagram::{
        CLOUDFLARED_DATAGRAM_V2_QUEUE_SIZE, CLOUDFLARED_DATAGRAM_V3_QUEUE_SIZE,
        CLOUDFLARED_V3_RESPONSE_DESTINATION_UNREACHABLE,
        CLOUDFLARED_V3_RESPONSE_ERROR_WITH_MESSAGE, CLOUDFLARED_V3_RESPONSE_OK,
    ...
    protocol::cloudflared_http2::{
        CLOUDFLARED_H2_CONTENT_TYPE_GRPC, CLOUDFLARED_H2_CONTENT_TYPE_NDJSON,
    ...
    protocol::cloudflared_icmp::{
        CLOUDFLARED_ICMP_FLOW_TIMEOUT, CLOUDFLARED_ICMP_IPV4_TTL_QUOTE_LENGTH,
    ...
    protocol::cloudflared_ingress::{
        ...
        CloudflaredConfigManager, CloudflaredIngressRule, CloudflaredIpRule,
        CloudflaredIpRulePolicy, CloudflaredLocalIngressRule,
        CloudflaredOriginRequestConfig, CloudflaredResolvedService,
        CloudflaredResolvedServiceKind, CloudflaredRuntimeConfig,
        CloudflaredWarpRoutingConfig, build_cloudflared_remote_config,
        compile_cloudflared_ingress_rules, match_cloudflared_ingress_host,
        match_cloudflared_ingress_rule, parse_cloudflared_resolved_service,
    },
    protocol::cloudflared_origin::CloudflaredOriginService,
    protocol::cloudflared_quic::{
        CLOUDFLARED_QUIC_HANDSHAKE_IDLE_TIMEOUT,
        CLOUDFLARED_QUIC_KEEP_ALIVE_INTERVAL,
        CLOUDFLARED_QUIC_MAX_IDLE_TIMEOUT, CLOUDFLARED_REGISTRATION_TIMEOUT,
        CloudflaredQuicDatagramSender, CloudflaredQuicEdge,
        CloudflaredQuicEvent, CloudflaredQuicHandler, CloudflaredQuicSession,
        CloudflaredQuicStream, cloudflared_quic_initial_packet_size,
        cloudflared_quic_transport_config,
    },
    protocol::cloudflared_supervisor::{
    ...
    protocol::tailscale::{
        ...
        TailscaleDerpFrame, TailscaleDerpReceivedMessage, TailscaleDerpSession,
        build_tailscale_derp_http_upgrade_request, encode_tailscale_derp_frame,
        parse_tailscale_derp_received_message, tailscale_node_public_key,
    },
    protocol::tailscale_control::{
        TAILSCALE_CONTROL_UPGRADE_PROTOCOL, TailscaleControlHandshake,
        TailscaleControlHttp2Client, TailscaleMapFrameDecoder,
    },
    protocol::tailscale_control_supervisor::{
        ...
        TailscaleControlSupervisorOptions, TailscaleControlSupervisorStatus,
        TailscaleHttp2ControlSession, TailscaleNetmapConsumer,
        TailscaleTkaSynchronizer, TailscaleTs2021DialConnector,
        bootstrap_tailscale_control, build_tailscale_control_connector,
    },
    protocol::tailscale_control_types::{
        TAILSCALE_MAP_PATH, TAILSCALE_REGISTER_PATH, TAILSCALE_SET_DNS_PATH,
        TAILSCALE_TKA_BOOTSTRAP_PATH, TAILSCALE_TKA_SYNC_OFFER_PATH,
        TAILSCALE_TKA_SYNC_SEND_PATH, TailscaleDnsConfig, TailscaleFilterRule,
        TailscaleMapRequest, TailscaleMapResponse, TailscaleNetmapState,
    ...
    protocol::tailscale_derp_manager::{
    ...
    protocol::tailscale_disco::{
        TAILSCALE_DISCO_MAGIC, TailscaleDiscoMessage, TailscaleDiscoPing,
        encode_tailscale_disco_message, tailscale_disco_public_key,
    },
    protocol::tailscale_disco_socket::{
        TailscaleDiscoPeer, TailscaleDiscoSocket, TailscaleDiscoSocketHandle,
        TailscaleDiscoSocketOptions, TailscaleDiscoSocketStatus,
        TailscalePacketSendOutcome,
    },
    protocol::tailscale_netcheck::{
        ...
        TailscaleEndpointType, TailscaleNetcheckReport, TailscalePortMapping,
        discover_tailscale_endpoints,
    },
    protocol::tailscale_path::{
        TAILSCALE_PATH_TRUST_DURATION, TailscalePathQuality,
        TailscalePeerPathState,
    },
    protocol::tailscale_ssh::{
    ...
    protocol::tailscale_ssh_recording::{
    ...
    protocol::tailscale_state::{
        TAILSCALE_DEFAULT_CONTROL_URL, TAILSCALE_NODE_FILE_NAME,
        TAILSCALE_TKA_FILE_NAME, TailscaleNodeFile, TailscaleNodeKeyRotation,
        TailscaleNodeStateStore, TailscalePrivateKey, TailscaleStateError,
        TailscaleTkaState,
    },
    protocol::tailscale_taildrop::{
        ...
        TailscaleTaildropError, TailscaleTaildropEvent, TailscaleTaildropFile,
        TailscaleTaildropInbox, TailscaleTaildropPeerAccess,
        TailscaleTaildropReceiver, TailscaleTaildropReceivingFile,
        TailscaleTaildropTarget, handle_tailscale_taildrop_request,
        send_tailscale_taildrop_file, tailscale_taildrop_targets,
        validate_tailscale_taildrop_file_name,
    },
    protocol::tailscale_tka::{
        TailscaleNetworkLockPrivateKey, TailscaleNodeKeySignature,
        TailscaleTkaError, resign_tailscale_node_key_signature,
    },
    protocol::tailscale_tka_authority::{
        TAILSCALE_TKA_COMPACTION_MIN_AGE, TAILSCALE_TKA_COMPACTION_MIN_CHAIN,
        TailscaleAum, TailscaleAumHash, TailscaleTkaAuthority,
        TailscaleTkaAuthorityError, TailscaleTkaAuthorityState,
        TailscaleTkaCompactionOptions, TailscaleTkaSyncOffer,
    },
    protocol::tailscale_tka_sync::TailscalePersistentTkaSynchronizer,
    protocol::tailscale_wireguard::{
        TailscaleWireGuardEngine, TailscaleWireGuardEvent,
        TailscaleWireGuardOptions, TailscaleWireGuardPeer,
        TailscaleWireGuardStatus,
    },
    protocol::{direct::DirectOutbound, hysteria2_realm::RealmControlClient},
    route::{
