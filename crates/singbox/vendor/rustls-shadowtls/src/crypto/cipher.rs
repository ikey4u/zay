...
pub trait MessageEncrypter: Send + Sync {
    ...
    /// Encrypt a TLS 1.3 message with zero-valued inner plaintext padding.
    /// Implementations for protocols without TLS 1.3 padding support retain
    /// their ordinary behavior when `padding_len` is zero.
