...
use crate::crypto::{
    CryptoProvider, KeyProvider, SecureRandom, SupportedKxGroup,
};
...
static SUPPORTED_SIG_ALGS: WebPkiSupportedAlgorithms =
...
pub mod kx_group {
    ...
    pub use super::pq::{
        MLKEM1024, MLKEM768, SECP256R1MLKEM768, X25519KYBER768DRAFT00,
        X25519MLKEM768,
    };
}
...
mod ring_shim {
    ...
    pub(super) fn agree_ephemeral(
        ...
        ring_like::agreement::agree_ephemeral(
            priv_key,
            peer_key,
            (),
