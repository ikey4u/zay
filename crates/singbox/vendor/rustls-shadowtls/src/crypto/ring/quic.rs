...
mod tests {
    ...
    fn short_packet_header_protection() {
        ...
        test_short_packet(
            Version::V1,
            &[
                0x4c, 0xfe, 0x41, 0x89, 0x65, 0x5e, 0x5c, 0xd5, 0x5c, 0x41,
                0xf6, 0x90, 0x80, 0x57, 0x5d, 0x79, 0x99, 0xc2, 0x5a, 0x5b,
                0xfb,
            ],
        );
    }
    ...
    fn key_update_test_vector() {
        ...
        let mut secrets = Secrets::new(
            ...
            OkmBlock::new(
                &[
                    0xb8, 0x76, 0x77, 0x08, 0xf8, 0x77, 0x23, 0x58, 0xa6, 0xea,
                    0x9f, 0xc4, 0x3e, 0x4a, 0xdd, 0x2c, 0x96, 0x1b, 0x3f, 0x52,
                    0x87, 0xa6, 0xd1, 0x46, 0x7e, 0xe0, 0xae, 0xab, 0x33, 0x72,
                    0x4d, 0xbf,
                ][..],
            ),
            OkmBlock::new(
                &[
                    0x42, 0xdc, 0x97, 0x21, 0x40, 0xe0, 0xf2, 0xe3, 0x98, 0x45,
                    0xb7, 0x67, 0x61, 0x34, 0x39, 0xdc, 0x67, 0x58, 0xca, 0x43,
                    0x25, 0x9b, 0x87, 0x85, 0x06, 0x82, 0x4e, 0xb1, 0xe4, 0x38,
                    0xd8, 0x55,
                ][..],
            ),
            TLS13_AES_128_GCM_SHA256_INTERNAL,
        ...
        assert!(equal_okm(
            ...
            &OkmBlock::new(
                &[
                    0x42, 0xca, 0xc8, 0xc9, 0x1c, 0xd5, 0xeb, 0x40, 0x68, 0x2e,
                    0x43, 0x2e, 0xdf, 0x2d, 0x2b, 0xe9, 0xf4, 0x1a, 0x52, 0xca,
                    0x6b, 0x22, 0xd8, 0xe6, 0xcd, 0xb1, 0xe8, 0xac, 0xa9, 0x6,
                    0x1f, 0xce
                ][..]
            )
        ));
        assert!(equal_okm(
            ...
            &OkmBlock::new(
                &[
                    0xeb, 0x7f, 0x5e, 0x2a, 0x12, 0x3f, 0x40, 0x7d, 0xb4, 0x99,
                    0xe3, 0x61, 0xca, 0xe5, 0x90, 0xd4, 0xd9, 0x92, 0xe1, 0x4b,
                    0x7a, 0xce, 0x3, 0xc2, 0x44, 0xe0, 0x42, 0x21, 0x15, 0xb6,
                    0xd3, 0x8a
                ][..]
            )
        ));
    ...
    fn short_packet_header_protection_v2() {
        ...
        test_short_packet(
            Version::V2,
            &[
                0x55, 0x58, 0xb1, 0xc6, 0x0a, 0xe7, 0xb6, 0xb9, 0x32, 0xbc,
                0x27, 0xd7, 0x86, 0xf4, 0xbc, 0x2b, 0xb2, 0x0f, 0x21, 0x62,
                0xba,
            ],
        );
    }
    ...
    fn test_multipath_aead_basic() {
        const SECRET: &[u8; 32] = &[
            ...
            19, 20, 21, 22, 23, 24, 35, 26, 27, 28, 29, 30, 31,
        ];
        const PN: u64 = 12345;
        const PATH_ID: u32 = 2;
        ...
        const EXPECTED: &[u8] = &[
            123, 139, 232, 52, 136, 25, 201, 143, 250, 89, 87, 39, 37, 63, 0,
            210, 220, 227, 186, 140, 183, 251, 13, 203, 6, 116, 204, 100, 166,
            64, 43, 185, 174, 85, 212, 163, 242, 141, 24, 166, 62, 228, 187,
            137, 248, 31, 152, 126, 240, 151, 79, 51, 253, 130, 43, 114, 173,
            234, 254,
        ];
