...
impl ConfigBuilder<ClientConfig, WantsVerifier> {
    ...
    pub fn with_root_certificates(
        ...
        self.with_webpki_verifier(
            WebPkiServerVerifier::new_without_revocation(
...
impl ConfigBuilder<ClientConfig, WantsClientCert> {
    ...
    pub fn with_client_auth_cert(
        ...
        let certified_key =
            CertifiedKey::from_der(cert_chain, key_der, &self.provider)?;
        Ok(
            self.with_client_cert_resolver(Arc::new(SingleCertAndKey::from(
                certified_key,
            ))),
        )
    }
    ...
    pub fn with_client_cert_resolver(
        ...
        ClientConfig {
            ...
            reality_dummy_ticket_compatibility: false,
