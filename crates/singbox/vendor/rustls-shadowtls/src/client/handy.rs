...
impl client::ClientSessionStore for NoClientSessionStorage {
    ...
    fn set_tls12_session(
        &self,
        _: ServerName<'static>,
        _: persist::Tls12ClientSessionValue,
    ) {
    }
...
mod cache {
    ...
    pub struct ClientSessionMemoryCache {
        servers:
            Mutex<limited_cache::LimitedCache<ServerName<'static>, ServerData>>,
    }
    ...
    impl ClientSessionMemoryCache {
        ...
        pub fn new<M: crate::lock::MakeMutex>(size: usize) -> Self {
            let max_servers = size
                ...
                / MAX_TLS13_TICKETS_PER_SERVER;
            Self {
                servers: Mutex::new::<M>(limited_cache::LimitedCache::new(
                    max_servers,
                )),
            }
        }
...
mod tests {
    ...
    fn test_noclientsessionstorage_does_nothing() {
        ...
        let server_cert_verifier: Arc<dyn ServerCertVerifier> =
            Arc::new(DummyServerCertVerifier);
        let resolves_client_cert: Arc<dyn ResolvesClientCert> =
            Arc::new(DummyResolvesClientCert);
        ...
        let SupportedCipherSuite::Tls13(tls13_suite) =
