            ...
            let deframer_output =
                if self.core.common_state.has_received_close_notify {
                    ...
                    match self.core.deframe(
                        ...
                        Err(err) => {
                            buffer
                                .queue_discard(buffer_progress.take_discard());
...
impl<'c, 'i, Data> From<ReadTraffic<'c, 'i, Data>>
    for ConnectionState<'c, 'i, Data>
{
...
impl<'c, 'i, Data> From<ReadEarlyData<'c, 'i, Data>>
    for ConnectionState<'c, 'i, Data>
{
...
impl<'c, Data> From<TransmitTlsData<'c, Data>>
    for ConnectionState<'c, '_, Data>
{
...
impl<Data> fmt::Debug for ConnectionState<'_, '_, Data> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::TransmitTlsData(..) => {
                f.debug_tuple("TransmitTlsData").finish()
            }

            Self::BlockedHandshake => {
                f.debug_tuple("BlockedHandshake").finish()
            }
