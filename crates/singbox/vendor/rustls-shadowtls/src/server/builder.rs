...
impl ConfigBuilder<ServerConfig, WantsServerCert> {
    ...
    pub fn with_single_cert(
        ...
        Ok(self.with_cert_resolver(Arc::new(SingleCertAndKey::from(
            certified_key,
        ))))
    }
    ...
    pub fn with_cert_resolver(
        ...
        ServerConfig {
            ...
            reality_server_random: None,
            reality_cipher_suite: None,
            reality_key_exchange_group: None,
            reality_server_extension_order: None,
            reality_handshake_record_lens: None,
            #[cfg(feature = "std")]
            ...
            cert_compression_cache: Arc::new(
                compress::CompressionCache::default(),
            ),
