...
use super::aead_2022::{
    decrypt_client_payload_aead_2022, decrypt_server_payload_aead_2022,
    encrypt_client_payload_aead_2022, encrypt_server_payload_aead_2022,
};
...
pub fn encrypt_client_payload(
    ...
    match method.category() {
        ...
        #[cfg(feature = "aead-cipher-2022")]
        CipherCategory::Aead2022 => encrypt_client_payload_aead_2022(
            context,
            method,
            key,
            addr,
...
pub fn encrypt_server_payload(
    ...
    match method.category() {
        ...
        #[cfg(feature = "aead-cipher-2022")]
        CipherCategory::Aead2022 => encrypt_server_payload_aead_2022(
            context, method, key, addr, control, payload, dst,
        ),
    }
}
...
pub fn decrypt_client_payload(
    ...
    match method.category() {
        ...
        #[cfg(feature = "aead-cipher-2022")]
        CipherCategory::Aead2022 => decrypt_client_payload_aead_2022(
            context,
            method,
            key,
            payload,
...
pub fn decrypt_server_payload(
    ...
    match method.category() {
        ...
        CipherCategory::Aead2022 => {
            decrypt_server_payload_aead_2022(context, method, key, payload)
                .map(|(n, a, c)| (n, a, Some(c)))
                .map_err(Into::into)
        }
    }
