...
pub struct ConnectOpts {
    ...
    #[cfg(target_os = "android")]
    pub vpn_socket_protect:
        Option<std::sync::Arc<Box<dyn android::SocketProtect + Send + Sync>>>,
...
impl ConnectOpts {
    ...
    {
        self.vpn_socket_protect =
            Some(std::sync::Arc::new(Box::new(f.make_socket_protect())));
    }
}
